...
class QuizPaperCard1 extends GetView<PdfController> {
  const QuizPaperCard1({Key? key, required this.model}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Ink(
      ...
      child: InkWell(
        borderRadius: UIParameters.cardBorderRadius,
        onTap: () => Get.offAndToNamed(pdfpage.routeName),
        child: Padding(
