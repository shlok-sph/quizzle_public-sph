...
class PdfModel {
  ...
  factory PdfModel.fromString(String jsonString) => PdfModel.fromJson(json.decode(jsonString));
  ...
  PdfModel.fromSnapshot(DocumentSnapshot<Map<String, dynamic>> snapshot)
      : id = snapshot.id,
